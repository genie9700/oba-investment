...
<div class="p-6 md:p-8">
    <div class="flex justify-between items-center mb-8">
        <h1 class="text-3xl font-bold text-white">Manage Payment Methods</h1>
        <button wire:click="create" class="px-4 py-2 bg-orange-500 text-white font-semibold rounded-lg hover:bg-orange-600">Add New Method</button>
    </div>
